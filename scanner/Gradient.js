...
// Create an array of 100 gradient colors between two colors.
const colorArray = gradient.array({
    colors: ['#4aa49a', '#e26053'],
    count: 100
});
console.log("Gradient array sample:", colorArray.slice(0, 5));

// Create a gradient factory mapping values from 0 to 100.
const colorAt = gradient.factory({
    colors: ['#4aa49a', '#e26053'],
    min: 0,
    max: 100
});
const colorAt70 = colorAt(70);
console.log("Color at 70:", colorAt70);

// Color conversion utilities.
const rgb = gradient.toRGB('#e26053');
console.log("RGB of #e26053:", rgb);
const hex = gradient.fromRGB({ r: 217, g: 65, b: 180 });
console.log("Hex from RGB {217,65,180}:", hex);

// Use terminal color for output.
console.log(gradient.terminal("hello world", colorAt(0)));
*/